...
server_msg_queue = queue.Queue(25)
...
class AutobahnTwistedClient:
    def __init__(self, settings):
        ...
        self.autobahn_factory = MyClientFactory(u"ws://" + self.settings[SETTINGS.SERVER_IP_ADDRESS] + ":9000")
...
class MyClientProtocol(WebSocketClientProtocol):
    ...
    def onMessage(self, payload, isBinary):
        ...
        if isBinary:
            ...
            server_msg_queue.server_msg_queue.put(msg)
